...
public final class ActivityAddKitchenBinding implements ViewBinding {
  @NonNull
  private final LinearLayout rootView;

  @NonNull
  public final MaterialButton btnAddKitchenUser;
  ...
  private ActivityAddKitchenBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton btnAddKitchenUser, @NonNull TextInputLayout emailLayout,
    ...
    this.btnAddKitchenUser = btnAddKitchenUser;
  ...
  @NonNull
  public static ActivityAddKitchenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddKitchenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_kitchen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddKitchenBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btn_add_kitchen_user;
      MaterialButton btnAddKitchenUser = ViewBindings.findChildViewById(rootView, id);
      if (btnAddKitchenUser == null) {
        break missingId;
      }
      ...
      return new ActivityAddKitchenBinding((LinearLayout) rootView, btnAddKitchenUser, emailLayout,
