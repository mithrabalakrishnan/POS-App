...
public class DiscountFragmentDirections {
  private DiscountFragmentDirections() {
  }

  @NonNull
  public static ActionCouponFragmentToSummaryFragment actionCouponFragmentToSummaryFragment(
      @NonNull TableInfoModel tableSummary) {
    return new ActionCouponFragmentToSummaryFragment(tableSummary);
  }

  public static class ActionCouponFragmentToSummaryFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionCouponFragmentToSummaryFragment(@NonNull TableInfoModel tableSummary) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionCouponFragmentToSummaryFragment setTableSummary(
        @NonNull TableInfoModel tableSummary) {
      if (tableSummary == null) {
        throw new IllegalArgumentException("Argument \"table_summary\" is marked as non-null but was passed a null value.");
      }
    ...
    public int getActionId() {
      return R.id.action_couponFragment_to_summaryFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionCouponFragmentToSummaryFragment that = (ActionCouponFragmentToSummaryFragment) object;
    ...
    public String toString() {
      return "ActionCouponFragmentToSummaryFragment(actionId=" + getActionId() + "){"
